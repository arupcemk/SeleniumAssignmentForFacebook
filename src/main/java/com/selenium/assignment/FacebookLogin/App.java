package com.selenium.assignment.FacebookLogin;
...
public class App 
{
    ...
    {
        System.out.println( "Lets try to login into facebook.com!" );
        ...
        driver.findElement(By.id("email")).sendKeys("arupcemk@gmail.com");
        
        //Thread.sleep(1000);
        
        //locate lastName field  and enter details
        
        driver.findElement(By.id("pass")).sendKeys("Munmun@123");
        //Thread.sleep(1000);
...
//To asses the actual result and the expected result above section can be used .
        ...
        driver.quit();
        System.out.println("Srcipt for Facebook login executed successfully");
